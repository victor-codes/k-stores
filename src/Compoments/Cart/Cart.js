...
export default function Cart() {
  ...
  const EmptyCartTemplate = (
    <div className={styles.empty_cart_message_flex}>
      ...
      {/* <AddToCart />
      <div>
        <h6 className={styles.heading_6}>Title blah blah</h6>

        <p className={styles.text_size}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nisi, porta
          morbi varius sollicitudin quam. Feugiat a, donec ullamcorper tellus mi
          suspendisse s
        </p>
      </div>
      <Button type="primary" value="Go back home" /> */}
    </div>
  );
  const cartTemplate = (
    <>
